...
def calculate():
    if request.method == "POST":
        ...
        return render_template("result.html", result1=num1, result2=num2, lcm=result, developer_name = "Patrick Amagne")
    else:  # method = GET
        # user has hit this page directly
        return render_template("result.html", developer_name = "Patrick Amagne")
